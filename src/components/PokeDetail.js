...
const PokeDetail = props => {
  ...
  const clickedPokemon = pokemons.filter(item => {
        ...
        <div className="detail__wrapper-content">
          ...
          <div className="detail__img-wrapper">
            <img
              ...
              src={clickedPokemon[0].image}
              alt={`Imagen frontal de ${clickedPokemon[0].name}`}
            />
            <img
              className="detail__img"
              src={clickedPokemon[0].imageBack}
              alt={`Imagen trasera de ${clickedPokemon[0].name}`}
            />
          </div>
